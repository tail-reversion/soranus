...
\cs_new:Nn \__soranus_set_document_publisher:nnn
  {
    \prop_gput:Nnn \g__soranus_document_metadata_prop { publish-name } { #1 }
    \prop_gput:Nnn \g__soranus_document_metadata_prop { publish-year } { #2 }
    \prop_gput:Nnn \g__soranus_document_metadata_prop { publish-address } { #3 }
  }
