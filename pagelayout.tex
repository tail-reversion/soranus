...
\msg_new:nnn { soranus } { page-layout-change }
  {
    On~page~\the\c@page,~the~page~layout~was~set~with~the~following~parameters:\\
    \iow_indent:n
      {
        text-width:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
          { \g__soranus_pagelayout_text_width_dim }\\
        text-height:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
        ...
        \bool_if:NT \g__soranus_pagelayout_two_column_bool
          {
            column-sep:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
              { \g__soranus_pagelayout_column_sep_dim }\\
            column-rule-width:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
              { \g__soranus_pagelayout_column_rule_width_dim }\\
          }
        margin-par-width:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
          { \g__soranus_pagelayout_margin_par_width_dim }\\
        margin-par-sep:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
          { \g__soranus_pagelayout_margin_par_sep_dim }\\
        margin-par-push:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
          { \g__soranus_pagelayout_margin_par_push_dim }\\
        spine-margin:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
          { \g__soranus_pagelayout_spine_margin_dim }\\
        top-margin:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
          { \g__soranus_pagelayout_top_margin_dim }\\
        header-height:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
          { \g__soranus_pagelayout_header_height_dim }\\
        header-sep:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
          { \g__soranus_pagelayout_header_sep_dim }\\
        footer-height:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
          { \g__soranus_pagelayout_footer_height_dim }\\
        footer-sep:~\__soranus_for_msg_dim_to_decimal_in_common_units:n
...
\DeclareTemplateCode { pagelayout } { standard } { 0 }
  ...
  }
  {
    ...
    \__soranus_set_column:nnnn
      ...
      { \g__soranus_pagelayout_column_sep_dim }
      { \g__soranus_pagelayout_column_rule_width_dim }
    \msg_info:nn { soranus } { page-layout-change }
  }
