...
\cs_new:Nn \__soranus_set_paper_size:nn
  {
    \dim_gset:Nn \g__soranus_paper_width_dim {#1}
    \dim_gset:Nn \g__soranus_paper_height_dim {#2}
  }

\dim_new:N \g__soranus_edge_trim_dim
\dim_new:N \g__soranus_top_trim_dim

\cs_new:Nn \__soranus_set_page_trim:nn
  {
    \dim_gset:Nn \g__soranus_edge_trim_dim {#1}
    \dim_gset:Nn \g__soranus_top_trim_dim {#2}
  }

\dim_new:N \g__soranus_page_width_dim
\dim_new:N \g__soranus_page_height_dim

\cs_new:Nn \__soranus_set_page_size:nn
  {
    \dim_gset:Nn \g__soranus_page_width_dim {#1}
    \dim_gset:Nn \g__soranus_page_height_dim {#2}
  }
...
\bool_new:N \g__soranus_twoside_bool
...
\DeclareInstance {pagelayout} {thepagelayout} {standard} {}
