...
\msg_new:nnn {soranus} {point-size-init}
  {
    The~document~main~font~size~has~the~following~parameters:\\
    \iow_indent:n
      {
...
\msg_new:nnn {soranus} {paper-init}
  {
    The~document~has~the~following~paper~and~page~properties:\\
    \iow_indent:n
      {
        ...
        two-side:~\bool_if:NTF \g__soranus_two_side_bool {true} {false}
      }
  }
