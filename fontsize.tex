...
\DeclareInstance { fontsize } { miniscule } { root-relative }
  {
    scale = 0.5
  }

\DeclareInstance { fontsize } { tiny } { root-relative }
  {
    scale = 0.6
  }

\DeclareInstance { fontsize } { scriptsize } { root-relative }
  {
    scale = 0.7
  }

\DeclareInstance { fontsize } { footnotesize } { root-relative }
  {
    scale = 0.8
  }

\DeclareInstance { fontsize } { small } { root-relative }
  {
    scale = 0.9
  }
...
\DeclareInstance { fontsize } { large } { root-relative }
  {
    scale = 1.2
  }
...
\DeclareInstance { fontsize } { huge } { root-relative }
  {
    scale = 2.4
  }
...
\DeclareInstance { fontsize } { smaller } { relative }
  {
    scale = 0.9
  }

\DeclareInstance { fontsize } { larger } { relative }
  {
