...
\cs_new_protected:Nn \__soranus_typeset_headfoot:NNNNN
  {
    \SetHorizontalCoffin \l__soranus_pagestyle_standard_internal_a_coffin
      {
    ...
    \dim_compare:nF { #1 = \c_zero_dim }
      {
        \SetHorizontalCoffin \l__soranus_pagestyle_standard_internal_b_coffin
          { \rule { \textwidth } { #1 } }
        \JoinCoffins
          \l__soranus_pagestyle_standard_internal_a_coffin [ l, t ]
          \l__soranus_pagestyle_standard_internal_b_coffin [ l, b ]
          ( 0pt, 3pt )
      }
    \dim_compare:nF { #2 = \c_zero_dim }
      {
        \SetHorizontalCoffin \l__soranus_pagestyle_standard_internal_b_coffin
          { \rule { \textwidth } { #2 } }
        \JoinCoffins
          \l__soranus_pagestyle_standard_internal_a_coffin [ l, b ]
          \l__soranus_pagestyle_standard_internal_b_coffin [ l, t ]
          ( 0pt, -2pt )
      }
    \TypesetCoffin \l__soranus_pagestyle_standard_internal_a_coffin ( 0pt, 2.5pt )
  }
...
\DeclareTemplateCode { pagestyle } { standard } { 0 }
  ...
  {
    \AssignTemplateKeys
    \cs_gset_protected:Npn \ps@soranus
      {
        \ps@empty
