...
\cs_new:Nn \__soranus_typeset_headfoot:NNNNN
  {
    \SetHorizontalCoffin \l__soranus_pagestyle_internal_a_coffin
      {
    ...
    \dim_compare:nNnF { #1 } = { \c_zero_dim }
      {
        \SetHorizontalCoffin \l__soranus_pagestyle_internal_b_coffin
          { \rule { \textwidth } { #1 } }
        \JoinCoffins
          \l__soranus_pagestyle_internal_a_coffin [ l, t ]
          \l__soranus_pagestyle_internal_b_coffin [ l, b ]
          ( 0pt, 3pt )
      }
    \dim_compare:nNnF { #2 } = { \c_zero_dim }
      {
        \SetHorizontalCoffin \l__soranus_pagestyle_internal_b_coffin
          { \rule { \textwidth } { #2 } }
        \JoinCoffins
          \l__soranus_pagestyle_internal_a_coffin [ l, b ]
          \l__soranus_pagestyle_internal_b_coffin [ l, t ]
          ( 0pt, -2pt )
      }
    \TypesetCoffin \l__soranus_pagestyle_internal_a_coffin ( 0pt, 2.5pt )
  }
